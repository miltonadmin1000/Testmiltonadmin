/*Testcase: Document inkomend
 ...
 Background: gebruiker is geautoriseerd voor de rollen 'Behandelaar Document inkomend' en 'Beleid x ASM'
 Background: gebruiker is ingelogd als tst01
 
  Scenario: interne opstarten D-zaak door medewerker
...
package DzaakgeneriekZaaktypeRegistrerenViaDocumentinkomend_INT_7;
...
public class TC_DocumentInkomendDzaakgenkZktypeRegViaDocInk {
...
// When: gebruiker vult in het veld 'Betreft' onder titel 'Kenmerken' de tekst in 'test d-zaak generiek'
driver.findElement(By.xpath("//input[@name='betreft']")).sendKeys("test d-zaak generiek");
System.out.println("gebruiker vult in het veld 'Betreft' onder titel 'Kenmerken' de tekst in 'test d-zaak generiek_OK");
...
WebElement td_Home = driver.findElement(By.cssSelector("#ext-gen587 > em:nth-child(1) > span:nth-child(1) > span:nth-child(1)"));

Actions builder = new Actions(driver);
Action mouseOverHome =  builder.moveToElement(link_Home).click().build(); 
mouseOverHome.perform();
System.out.println("Then: systeem opent tabblad 'inhoud'");
try {
	Thread.sleep(5000);
} catch (InterruptedException e) {
...
// When: gebruiker klikt rechts op knop '<<' boven 'bijlagen'
	ClickElement.clickByID(driver, "ext-gen1123");	
